<?php
	...
	Route::group([
			...
			Route::any('/liveness','/liveness.php');
			...
			Route::any('/contest/search','/contest_search.php');

			Route::any('/exercises', '/exercise_home.php');
			Route::any('/exercise/{id}', '/exercise.php');
			Route::any('/exercise/{id}/submissions', '/exercise.php?tab=submissions');
			Route::any('/exercise/{id}/standings', '/exercise.php?tab=standings');
			Route::any('/exercise/{id}/manage', '/exercise_manage.php');

			Route::any('/ladder','/ladder.php');
			Route::any('/ladder/manage','/ladder_manage.php');

			Route::any('/problems', '/problem_set.php');
			Route::any('/problems/template', '/problem_set.php?tab=template');
			Route::any('/autocopy', '/autocopy.php');
			...
			Route::any('/solution/new', '/add_solution.php');
			Route::any('/problem/{id}/solution', '/solution.php');
			Route::any('/solution/manage', '/solution_manage.php');
			...
			Route::any('/copyright', '/copyright.php');
			
			Route::any('/server','/server.php');
			...
			Route::any('/poem','/poem/poem.php');
			Route::any('/logout', '/logout.php');

			Route::any('/user/list', '/user_info.php?list=user');
			...
			Route::any('/user/upload','/user_upload.php');
			
			Route::any('/super-manage(?:/{tab})?', '/super_manage.php');
			Route::any('/upload', '/upload.php');
			
			Route::any('/min/{tab}', '/minify.php');
			Route::any('/files/{tab}', '/filelink.php');
			Route::any('/click-zan', '/click_zan.php');
			
			Route::any('/HKR', '/HKR.php');
			Route::any('/mysql', '/mysql.php');
			Route::any('/test', '/test.php');
		}
	);
