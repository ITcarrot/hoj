...
function queryUser($username) {
	...
	return DB::selectFirst("select * from user_info where username='$username'");
}
function queryProblemContent($id) {
	return DB::selectFirst("select * from problems_contents where id = $id");
}
function queryProblemBrief($id) {
	return DB::selectFirst("select * from problems where id = $id");
}
...
function querySubmission($id) {
	return DB::selectFirst("select * from submissions where id = $id");
}
function queryHack($id) {
	return DB::selectFirst("select * from hacks where id = $id");
}
function queryContest($id) {
	return DB::selectFirst("select * from contests where id = $id");
}
function queryContestProblem($id) {
	return DB::selectFirst("select * from contest_problems where contest_id = $id");
}
...
function queryBlog($id) {
	return DB::selectFirst("select * from blogs where id='$id'");
}
...
function queryBlogComment($id) {
	return DB::selectFirst("select * from blogs_comments where id='$id'");
}
...
function deleteBlog($id) {
	...
	DB::delete("delete from solutions where blog_id = $id");
	DB::manage_log('delete','delete blog '.$id);
}