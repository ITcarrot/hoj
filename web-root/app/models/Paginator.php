...
class Paginator {
	...
	public function pagination() {
		...
		$html .= '</ul>';
		$html .=<<<EOD
		<form style="display:inline-block;vertical-align:top;position: relative;">
			<input type="text" class="form-control input-sm" name="page" style="display: inline;width: 55px;">
			&nbsp;页&nbsp;
			<button type="submit" class="btn btn-primary glyphicon glyphicon-share-alt" style="vertical-align:baseline"></button>
		</form>
EOD;
		$html .= '</div>';
		return $html;
