<?php
	...
	$set_open->addCheckBox('is_open', '公开比赛？', $contest['is_open']==1);
...
<!--		<p>+233[full]表示添加题号为233的试题，比赛时直接显示评测结果，<font color="green">赛后不需要重测</font></p>-->
	...
	<div class="tab-pane" id="tab-others">
		<div class="row">
			...
			<div class="col-sm-12">
				<h3>版本控制</h3>
				<h4>版本1：排名第二关键字为罚时=最后一次提交时间+20分钟*（提交次数-1），未得分的程序不计罚时</h4>
				<h4>版本2（默认）：排名第二关键字为程序运行时间之和，未得分的程序的运行时间不计入总运行时间</h4>
